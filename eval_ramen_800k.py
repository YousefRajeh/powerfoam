"""Evaluate ramen's 800k-primitive Feature Foam checkpoint with the real, unmodified
...
result = metrics.compute_metrics(Path(r"D:\Downloads\claude_logs\_ramen_800k_fixed_tmp"), mode="attention_map")
print(f"ramen 800k: mIoU={result['scene_mean']['mIoU']:.4f} mAcc={result['scene_mean'].get('mAcc', float('nan')):.4f}")
